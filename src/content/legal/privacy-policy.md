...
We generally do not collect Sensitive Personal Information unless required for specific services or functionalities. When we do collect Sensitive Personal Information, we will:
...
**a. Direct Collection.**
Information that you provide directly to us when:
...
Information we may receive from third-party sources, including:
- Business partners
...
|----------|----------|-----------|
| A. Identifiers | Name, alias, postal address, unique personal identifier, online identifier, IP address, email address, account name | YES |
